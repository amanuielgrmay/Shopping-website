...
// creating end point for registaring the user
...
app.post("/submitCart", async (req, res) => {
  try {
    ...
    // Reset the cart data to an empty object
    user.cartData = {};
    ...
    res.status(200).json({
      success: true,
      message: "Cart submitted and reset successfully.",
    });
  } catch (error) {
